...
st.subheader("⏰ Última carga realizada por operador")
...
st.markdown(
    ...
    ">
        ...
        <h3>
            {fecha_ultima_carga.strftime("%d/%m/%Y")}
        </h3>

        <h3>
            Hora: {fecha_ultima_carga.strftime("%H:%M")}
        </h3>
        ...
        <h3>
            {horas_sin_carga:.1f} horas desde la última carga
        </h3>
